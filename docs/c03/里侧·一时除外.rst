...
-  | 『这张卡的①的效果特殊召唤的这张卡』『这张卡的①的方法特殊召唤的这张卡』这样，自身效果特殊召唤的情报在变成里侧表示后丢失。
...
-  | 『这个方法特殊召唤的这张卡』的情报，如果是可以通常召唤的怪兽，在变成里侧表示或被一时除外后丢失。
   | 如果是不能通常召唤的怪兽，在变成里侧表示后丢失，被一时除外的场合不丢失，效果可以发动，但是不会持续适用的（=仅在处理时适用1次）的变更自身攻击力·守备力·等级等相关的效果不再适用。
   | 例：
...
-  | 『这张卡的①的方法召唤的这张卡』『这个方法召唤的这张卡』这样，通过自身方法召唤的情报在变成里侧表示后丢失。
...
-  | 『○○（字段·卡名）的效果特殊召唤的这张卡』这样，特定卡名的效果特殊召唤的情报在变成里侧表示后丢失。
   | 被一时除外的场合不丢失，效果可以发动，但是不会持续适用的（=仅在处理时适用1次）的变更自身攻击力·守备力·等级等相关的效果不再适用。
   | 例：
   ...
   .. attention:: 特别地，「`死者苏生`_」特殊召唤的怪兽被一时除外的场合，回到场上后不会再因「`来自黑暗的呼声`_」的效果送去墓地。
