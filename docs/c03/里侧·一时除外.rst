...
| 当回合S召唤的「`废品增速者`_」被「`亚空间物质回送装置`_」的①效果除外再回到场上的场合，是否还能发动②效果，是否会被「`暗之闪光`_」的效果破坏，调整中。
| 「`冰水咒缚`_」的①效果适用中，当回合召唤·反转召唤·特殊召唤的「`发条鲨`_」被「`亚空间物质回送装置`_」的①效果除外再回到场上的场合，是否可以发动②效果，调整中。
