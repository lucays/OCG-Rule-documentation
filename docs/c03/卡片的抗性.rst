...
-  | 之前已经适用过的效果，即使怪兽进入不受效果影响的状态，也就那样适用。
   ...
   | 「`赫之烙印`_」的①效果融合召唤了「`吞食圣痕之龙`_」的场合，即使场上·墓地存在「`艾克莉西娅`_」，这个回合这只「`吞食圣痕之龙`_」也不能直接攻击。\ `26/3/26 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=5&fid=24309&keyword=&tag=-1&request_locale=ja>`__
...
.. _`艾克莉西娅`: https://ygocdb.com/card/name/艾克莉西娅
