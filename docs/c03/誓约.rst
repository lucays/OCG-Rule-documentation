...
| 「`DD 俄耳托斯`_」「`DDD 双晓王 末法神`_」的这类记述在特殊召唤成功后适用，是\ **在场上适用的效果**\ 。适用这个效果的玩家是特殊召唤成功时的控制者。\ `23/2/18 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=5&fid=17824&keyword=&tag=-1&request_locale=ja>`__
