...
-  | 基本上，即使处理时后1步不能适用的场合，前1步也会适用。
   ...
   .. attention::
      ...
      | 「`复仇死者的续魂再结`_」的①效果处理时，可用怪兽区域不足，结果可以被特殊召唤的怪兽等级合计比给对方观看的怪兽低的场合，不能进行仪式召唤，这个效果完全不适用，不会特殊召唤被除外的怪兽。\ `18/9/10 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=5&fid=22130&keyword=&tag=-1&request_locale=ja>`__
...
.. attention:: 「`分离的烙印`_」的①效果\ `22/4/23 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=4&cid=17472&request_locale=ja>`__\ 和「`真炎龙 白界龙`_」的②效果\ `23/1/14 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=4&cid=18498&request_locale=ja>`__\ 记述的是『那些怪兽在双方场上各1只特殊召唤』，虽然记述是『那些』，但同时明确记述了数量『各1只』，效果处理时如果有1只不能特殊召唤，另1只也不会特殊召唤。
