...
| 装备卡装备中，被装备的怪兽称装备怪兽，装备卡和装备怪兽\ :ref:`持续取对象`\ ，占用1个魔法·陷阱卡区域。即使对象怪兽的控制权被对方得到，持续取对象的装备魔法如无特别记述，仍然留在自己场上。
...
-  | 「`最强之盾`_」等装备卡有装备条件，只能给特定的种族·属性·等级·攻击力等的怪兽装备，「`善变的裁缝师`_」等文本会记述为『正确对象』。
   ...
   | 这些装备卡装备中，装备怪兽不满足装备条件时，基本上在那个时点立即被破坏，不当作被效果破坏，那个怪兽不再当作『装备怪兽』。不过「`龙魂之力`_」「`破坏炮`_」这类特殊文本的卡片，只在自身效果适用时，仍然是正确对象。
   | 例：
   ...
   | 「`斯蒂格马大日`_」的效果可以把通过自身效果当作装备魔法卡装备的「`大日超立方体`_」或「`大日五胞体`_」转移到自己怪兽区域正确的「`大日`_」怪兽上。转移后「`大日超立方体`_」或「`大日五胞体`_」的『这个效果当作装备卡使用的场合』效果仍适用。\ `26/6/6 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=5&fid=11251&keyword=&tag=-1&request_locale=ja>`__
   | 「`斯蒂格马大日`_」的效果不能把通过自身效果当作装备魔法卡装备的「`大日球体`_」「`大日四面体`_」「`大日星状体`_」「`大日棱柱体`_」转移到其他怪兽，因为这些怪兽的正确对象只有其效果装备的怪兽。\ `26/6/6 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=5&fid=11251&keyword=&tag=-1&request_locale=ja>`__
   | 「`斯蒂格马大日`_」的效果不能把「`欧米伽大日`_」效果当作装备魔法卡装备的「`大日`_」怪兽转移到其他怪兽，因为这些装备卡的正确对象只有「`欧米伽大日`_」自身。\ `26/6/6 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=5&fid=11251&keyword=&tag=-1&request_locale=ja>`__

-  | 装备卡给怪兽装备的处理时，对象怪兽不在怪兽区域表侧表示存在的场合，不能装备而送去墓地，这个场合不是被破坏，也不是因对方而从场上离开。
   | 装备卡装备中，装备怪兽不在怪兽区域表侧表示存在的场合，装备卡被破坏。这个场合不是被效果破坏。
   | 上述场合，装备卡不当作『怪兽装备的这张卡』，那个怪兽不当作『装备怪兽』。
   | 例：
   | 「`圣剑 加拉廷`_」发动时，连锁发动「`雷破`_」把其对象怪兽破坏的场合，不能装备而送去墓地，不是破坏，因此自身③效果不能发动。
   | 「`圣剑 加拉廷`_」装备中，发动「`雷破`_」把其对象怪兽破坏的场合，「`圣剑 加拉廷`_」被破坏，自身③效果可以发动。
   | 「`幻惑眼纳祭神`_」的①效果发动时不确定哪只怪兽会变成装备卡，处理时自身不在场上表侧表示存在或者没有可用的魔法·陷阱卡区域的场合，这个效果不适用。\ `25/12/19 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=4&cid=22212&request_locale=ja>`__
   | 「`纳祭之魔`_」等，确定会把某只怪兽变成装备卡的效果处理时，装备怪兽不在场上表侧表示存在的场合，由于没有装备上，那些怪兽也送去墓地，不当作被破坏。\ `22/4/29 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=4&cid=4737&request_locale=ja>`__
