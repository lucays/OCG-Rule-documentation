...
| 「`命运之抽卡`_」「`交错之魂`_」等也一样，魔法·陷阱·怪兽效果发动无效的场合，仍然计数，直到回合结束时不能再发动效果。\ `25/11/27 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=5&fid=23158&keyword=&tag=-1&request_locale=ja>`__ \ `20/12/18 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=4&cid=15838&request_locale=ja>`__
| 例：
