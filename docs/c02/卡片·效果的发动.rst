...
.. note::
   ...
   | 即使是把P卡放置到P区域这样发动魔法卡，在卡的发动时没有效果处理的状况，也是魔法卡的效果发动。也就是说，卡的发动其实也是效果的发动。\ `25/4/7 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=5&fid=24092&keyword=&tag=-1&request_locale=ja>`__
   | 可以理解成，在卡的发动时，必定伴随一个效果的发动（只不过也许是空效果）。
   | 本段其实仅指『卡的发动之外状况的效果的发动』，而卡片效果文本中的『效果的发动』=『卡的发动』+『卡的发动之外状况的效果的发动』。
   | 例：
   | 「幽鬼兔」记述的是『场上的\ **已是**\ 表侧表示存在的魔法·陷阱卡的效果发动时』，因此不能对应卡的发动，只能对应『卡的发动之外状况的场上效果的发动』。
   | 「`饼蛙`_」记述的『怪兽效果·魔法·陷阱卡发动时』对应怪兽效果的发动和魔法·陷阱卡的发动，不能对应『卡的发动之外状况的效果的发动』。
   | 「`流天类星龙`_」记述的『魔法·陷阱·怪兽效果发动时』和「`电子龙·无限`_」记述的『卡的效果发动时』处理一致，可以对应任意『卡的发动』+『效果的发动』。这种对应面最广。

   | 此外，『卡的发动之外状况的效果的发动』的顺序和卡的发动顺序类似，只是不存在第1步。
   | 例：
...
.. tip:: 也就是说，「`神之警告`_」对应不了「`未来融合`_」效果的发动，同样也对应不了「`炼狱的虚梦`_」等效果的发动。
...
| 「`永远之魂`_」只进行卡的发动时，那个连锁上不能再发动①效果。\ `24/3/22 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=4&cid=11672&request_locale=ja>`__
...
| 「`命运之抽卡`_」「`交错之魂`_」等也一样，魔法·陷阱·怪兽效果发动无效的场合，仍然计数，直到回合结束时不能再发动效果。\ `25/11/27 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=5&fid=23158&keyword=&tag=-1&request_locale=ja>`__
| 例：
...
| 「`召唤兽 卡利古拉`_」在场上存在，自己怪兽效果发动被无效的场合，这个回合自己怪兽的效果不可以再发动。此外，「`欢聚友伴·茸茸长尾山雀`_」的效果发动被无效，这个回合内发动第2张「`欢聚友伴·茸茸长尾山雀`_」的效果，『自己只能有1次把这张卡以外的「`欢聚友伴`_」怪兽的效果发动』适用的场合，第1次发动无效的次数仍然计入，这个回合不能发动第3张「`欢聚友伴`_」怪兽的效果。\ `25/3/27 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=5&fid=7813&keyword=&tag=-1&request_locale=ja>`__
...
| 记述『这个卡名的以下效果1回合各能选择1次』的卡片，那些『●』效果发动被无效，或发动的效果被无效的场合，那个回合不能再次发动同1个『●』效果。\ `26/1/30 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=5&fid=23977&keyword=&tag=-1&request_locale=ja>`__
...
| 例：
| 「`终焉之地`_」的效果把「`卡通王国`_」发动，「`卡通王国`_」发动时的时点还在「`终焉之地`_」的效果处理途中，其①效果不能在「`终焉之地`_」的效果处理途中适用，即使卡组不足3张，也可以这样来发动。这次场地魔法卡的发动不会被「`魔宫的贿赂`_」等连锁。
| 自己卡组没有「`神数`_」怪兽的场合，也可以用「`弹出式翻页`_」发动「`神数的神托`_」。
...
| 不过，仍然是发动了魔法·陷阱卡，「`自然蔷薇鞭`_」或「`大将军 紫炎`_」等计数效果照常计算。
| 例：
...
| 「`虚拟世界`_」的效果处理让场地魔法卡发动的回合，也是『魔法卡的效果发动的回合』，满足「`毁灭之黑魔术师`_」的特殊召唤手续。\ `25/6/30 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=5&fid=24193&keyword=&tag=-1&request_locale=ja>`__
...
-  | 特别地，发动后会变成确定装备怪兽的装备卡等，持续在当前区域表侧表示存在的魔法·陷阱卡，在连锁途中可以从场上回到手卡·卡组。
   | 发动后会再度盖放自身，或者特殊召唤·变成X素材的魔法·陷阱卡，在连锁途中不能从场上回到手卡·卡组。\ `26/2/21 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=5&fid=8129&keyword=&tag=-1&request_locale=ja>`__
   | 例：
   ...
   | 「`金属化·强化反射装甲`_」「`金属化·钢炎装甲`_」发动时不能确定装备怪兽，不能连锁以它们为对象发动「`凤翼的爆风`_」「`星圣·昴星团`_」的①效果。
