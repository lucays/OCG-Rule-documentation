...
.. tip::
   ...
   | 如果只想看\ **精确匹配**\ 的搜索结果，需要在搜索词前后加上英文引号\ ``''``\ 。假如搜索词是『这个回合』，应该输入『"这个回合"』。
...
| pdf目前不显示效果编号，epub没有这个问题，并且重新排版了文本，更适合手机阅读。
| 阅读器方面，手机端推荐多看阅读app（需下载安装），电脑端直接用windows10内置的Edge浏览器即可（无需下载软件）。
