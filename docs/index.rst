...
| 游戏王OCG规则繁杂，中文资料大都比较陈旧，\ `新大师完全规则书 <https://warsier.gitbooks.io/new_master_rule>`__\ 部分内容仍不够详细，因此我整理出了这个网站，方便查阅。
| 新手需要注意：开始玩这个游戏\ **不需要**\ 看完本站所有内容。并且，即使看完并通晓这些规则，也只代表你可以成为规则大师，并不意味着你是高玩，这两者没有必然联系。实际上，很多厉害的玩家对规则的了解程度也不太深。
| 本站内容较多，全部记住几乎是不可能的，我也记不住。碰到问题时知道在哪或要搜什么一般就可以了。不过，新大师规则和OCG规则基础部分的文章还是有必要阅读的。
| 本站涉及的主要是疑难的规则和调整，如果是不清楚怎么召唤怪兽等，这里找不到答案的\ **基础问题，需要先看**\ \ `新大师完全规则书 <https://legacy.gitbook.com/book/warsier/new_master_rule/details>`__\ 。
...
| pdf格式适合电脑查看（windows10内置的Edge浏览器即可打开），epub格式重新排版了文本，更适合手机阅读（推荐多看阅读app）。
