...
| 「`唤醒你沉睡的元素英雄`_」的效果被无效化的场合，①效果让攻击力上升的部分不再适用，回到原本的攻击力。但是，仍然可以对怪兽作出多次攻击。\ `22/2/18 <https://www.db.yugioh-card.com/yugiohdb/faq_search.action?ope=5&fid=23570&keyword=&tag=-1&request_locale=ja>`_
