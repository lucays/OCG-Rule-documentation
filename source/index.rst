...
| 游戏王OCG规则繁杂，中文资料大多比较陈旧，\ `新大师规则书 <https://legacy.gitbook.com/book/warsier/new_master_rule/details>`__\ 部分内容不够详细，因此我整理出了这个网站，方便查阅。
| 本站只涉及游戏王OCG的重难点规则，比起规则书更加详细。由于不是完整的OCG规则，没有涉及的内容还是要查规则书。
| 部分内容很难记住，大多也没有必要记住，只要还记得在哪一篇介绍的，遇到问题时查看即可。
| 从app内跳转过来，想知道网址的话，可以直接百度搜索\ ``ocg rule``\ ，搜索结果中前3个都是，之后可以加为浏览器书签。
| 如果发现内容错误或没有及时更新，可以通过下方\ 联系方式_\ 联系我修正。
