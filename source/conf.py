...
latex_elements = {
    ...
    #
    # 'figure_align': 'htbp',
    'sphinxsetup': 'attentionBorderColor={rgb}{1,1,1}, noteBorderColor={rgb}{1,1,1}, tipBorderColor={rgb}{1,1,1}, attentionBgColor={rgb}{1,0.87,0.678}, noteBgColor={rgb}{0,0.96,1}, tipBgColor={rgb}{1,0.412,0.706}',
    'preamble': r'''
